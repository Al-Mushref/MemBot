...
// holds all elements we need to display the dialogue between the user and the
// chatbot
...
public:
  ...
  // events
  // drawin the background image
  void paintEvent(wxPaintEvent &evt);
  void paintNow();
  void render(wxDC &dc);

  // proprietary functions -> add dialog items
...
// Load items
// can be either from the user or the chatbot
// has image
